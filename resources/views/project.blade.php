    ...
    <div id="body">
        <div class="header">
            <div>
                ...
                <ul>
                    <li>
                        <a href="{{url('proj')}}"><img src="{{asset('asset/images/curious-rover.jpg')}}" alt=""></a>
                        <div>
                            ...
                            <a href="{{url('proj1')}}" class="more">Read More</a>
                        </div>
                    </li>
                    <li>
                        <a href="{{url('proj1')}}"><img src="{{asset('asset/images/space-station.jpg')}}" alt=""></a>
                        <div>
